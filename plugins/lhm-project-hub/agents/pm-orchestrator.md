...
| `lhm-project-hub:weekly-web-project-brief` | Weekly website portfolio email or consolidated corrections to an existing brief; uses red-first traffic lights, source-backed dates and HTML delivery. |
