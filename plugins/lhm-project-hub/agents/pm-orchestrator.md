...
| `lhm-project-hub:weekly-web-project-brief` | Weekly website portfolio email or consolidated corrections to an existing brief; uses project-only traffic lights, inactivity checks, full owner Inbox sweeps, concise client-grouped weekly actions, fresh Codex CLI research and HTML delivery. |
