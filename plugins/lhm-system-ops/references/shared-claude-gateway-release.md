...
Release 0.8.5 supervises each worker for its full lifecycle. The root dispatcher maintains
...
Release 0.8.5 retains the Google Ads reconciliation evidence boundary and adds explicit Prototype,
