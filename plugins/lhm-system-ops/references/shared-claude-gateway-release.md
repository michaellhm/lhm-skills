...
Release 0.8.7 supervises each worker for its full lifecycle. The root dispatcher maintains
...
Release 0.8.7 raises only the admitted `google_ads_readonly` elapsed-time ceiling from 300 to 600
...
Release 0.8.7 also retains the Google Ads reconciliation evidence boundary and explicit Prototype,
