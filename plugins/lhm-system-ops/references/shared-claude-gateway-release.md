...
CAP-015 release 0.8.2 supervises each worker for its full lifecycle. The root dispatcher maintains
...
Release 0.8.2 also adds the Google Ads reconciliation evidence boundary. The dispatcher reads only
