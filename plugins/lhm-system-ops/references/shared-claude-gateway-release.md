...
Release 0.8.6 supervises each worker for its full lifecycle. The root dispatcher maintains
...
Release 0.8.6 retains the Google Ads reconciliation evidence boundary and adds explicit Prototype,
