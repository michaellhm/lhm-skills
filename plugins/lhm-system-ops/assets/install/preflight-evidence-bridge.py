...
EXPECTED={
 ...
 "fathom_backend":"/usr/local/libexec/lhm-evidence-fathom-backend",
}
def main():
    ...
    for name,path in EXPECTED.items():
        ...
        stat=item.stat()
        if name in ("claude_dispatcher","claude_worker","fathom_backend") and (stat.st_uid != 0 or stat.st_mode & 0o777 != 0o755):
