...
""")
    ...
    (registry / "run-one.json").write_text(json.dumps({"sources":[{"kind":"google_drive_file","identifier":"drive-exact"},{"kind":"fathom_transcript","identifier":"fathom-exact"}],"destination_identifier":"folder-exact"}))
    ...
    fathom = invoke(links["lhm-fathom-transcript-read"], {"run_id":"run-one","identifier":"fathom-exact"}, env).decode().strip()
