...
`weekly-web-project-brief` — Lily’s Monday HTML website portfolio: project health, inactivity checks, concise client-grouped owner Inbox actions and an unattended Codex route, source freshness and consolidated feedback. One-off fixes stay out of the snapshot. Disclosed project blockers travel in the normal email; bounded corrections and independent watchdog emails cover failed runs.
