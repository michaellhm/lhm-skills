...
`weekly-web-project-brief` — Lily’s Monday HTML website portfolio: project health, inactivity checks, specific owner Inbox actions, source freshness and consolidated feedback. One-off fixes stay out of the snapshot.
