...
| "digital audit", "audit analytics", "check GA4 setup", "check tracking", "verify conversions", "digital audit for [client]" | `digital-audit` skill |
...
- Digital audit → `${CLAUDE_PLUGIN_ROOT}/skills/digital-audit/SKILL.md`
...
| `digital-audit` | User wants to check a client's GA4 setup, verify conversion tracking, or run the digital audit |
